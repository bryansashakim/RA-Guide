...
# Load data ---------------------------------------------------------
trend_data <- read_csv("/Users/bryankim/Documents/R/Shiny intro/trend_data.csv")
trend_description <- read_csv("/Users/bryankim/Documents/R/Shiny intro/trend_description.csv")
